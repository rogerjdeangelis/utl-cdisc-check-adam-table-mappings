...
We do this using my utl_voodoo macro                                  

Given production tables sdtm.dm, sdtm.vs and production adam sl check then mappings programatically.
...
Process flow
    1. Identify the sdtm domains neede to create the adam daset.
    2. Rename all the veriables in each sdtm with the comain name ie dm_age
    3. Rename all variables in the adam datasets ie adsl rename sl_studyid ...
    4. Run voodoo macro
    5  Examine voodoo output particularly the findings above
 _                   _
(_)_ __  _ __  _   _| |_
| | `_ \| `_ \| | | | __|
| | | | | |_) | |_| | |_
